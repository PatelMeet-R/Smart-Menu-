                                        ...
                                        <tr>
                                            ...
                                            <td data-column="status">
                                                <?php 
																			...
																			{
																			?>
                                                <button type="button" class="btn btn-info"><span class="fa fa-bars" aria-hidden="true"></span> 5 Min Wait</button>
                                                <?php 
																			  }
                                                ...
                                                <?php
																			if($status=="rejected")
																				{
																			?>
                                                <button type="button" class="btn btn-danger"> <i class="fa fa-close"></i> Unavailable now</button>
                                                <?php 
																			} 
																			?>
