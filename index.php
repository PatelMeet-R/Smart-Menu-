...
<head>
    ...
    <link rel="icon" href="#">
    <title>Home ||SmartMenu-Online Food Ordering System -Meet Patel</title>
...
<body class="home">
    ...
    <section class="hero bg-image" data-image-src="images/img/rimg.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1> Serve at your Table  </h1>
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span style="color:white;">1. </span>Choose Restaurant-Zone</h4>
                    </div>
                    ...
                    <div class="step-item step3">
                        ...
                        <h4><span style="color:white;">3. </span>Serve at your Table </h4>
                    </div>
        ...
        <div class="container">
                ...
                <div class="row how-it-works-solution">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <h3>Serve at your Table </h3>
                            <p>Get your food Served! And enjoy your meal! </p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12 text-center">
                    <p class="pay-info"> we receive offline payment right now</p>
                </div>
            </div>
        </div>
    </section>
