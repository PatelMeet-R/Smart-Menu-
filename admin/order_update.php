                            ...
                            <table border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td><select name="status" required="required">
                                            ...
                                            <option value="rejected"> 5 Min Wait</option>
                                            <option value="rejected"> 10 Min Wait</option>
                                            <option value="rejected"> 20 Min Wait</option>
                                            <option value="rejected"> 40 Min Wait</option>
                                            <option value="rejected"> Unavailable now</option>
